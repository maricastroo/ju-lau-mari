export const quizData = [
  {
    ...
    opcoes: [
      ...
      "Vida VS. Saúde pública",
      "Ordem econômica e financeira VS. família",
...

  {
    ...
    opcoes: [
      ...
      "Honra VS. Administração Pública",
      "Interesses internacionais VS. Democracia"
    ],
    respostaCorretaIndex: 1,
    explicacao: " A integridade do processo eleitoral ganhou nesse caso, pelo STF entender que a disseminação de fake news por agentes públicos, especialmente em contextos eleitorais, pode configurar abuso de poder e justificar sanções severas, incluindo cassação de mandato e inelegibilidade.",
  },
...

  {
    ...
    opcoes: [
      ...
      "Privacidade e intimidade VS. Autonomia estadual e Interferência governamental",
      "Saúde VS. Segurança"
    ],
    respostaCorretaIndex: 2,
    explicacao: "Fundamentos da Decisão (Voto do Relator e acompanhamento de Ministros): O Ministro Relator Luiz Fux e outros Ministros (André Mendonça, Nunes Marques, Dias Toffoli, Alexandre de Moraes e Roberto Barroso) votaram pela procedência da ação para declarar a inconstitucionalidade dos artigos impugnados. Os fundamentos incluíram a violação dos princípios da privacidade, intimidade e devido processo legal substantivo. Considerou-se que a medida restritiva de direitos (coleta obrigatória e arquivamento de material genético) não se mostrava estritamente necessária ou adequada, acarretando ônus inúteis. (Filtros Constitucionais - Princípio da Proporcionalidade). Além disso, foi apontada a omissão da lei quanto a salvaguardas e gerenciamento dos dados, implicando vulnerabilidade do sigilo das informações coletadas. A tese proposta foi que 'É inconstitucional a lei estadual que preveja o arquivamento de materiais genéticos de nascituros e parturientes, em unidades de saúde, com o fim de realizar exames de DNA comparativo em caso de dúvida'. Referências a declarações internacionais sobre dados genéticos que exigem consentimento prévio foram utilizadas para nortear a decisão."
  },

  {
    ...
    opcoes: [
      ...
      "Autodeterminação informativa VS. Liberdade",
      "Inviolabilidade de dados VS. Informação"
    ],
    respostaCorretaIndex: 3,
    explicacao: "A MP foi atacada por violar preceitos fundamentais relacionados à inviolabilidade de dados, privacidade, intimidade, sigilo de dados, e o direito fundamental à autodeterminação informativa. Argumentou-se que a medida violava o princípio da proporcionalidade, em seus sub-princípios de adequação, necessidade e justa medida, por não delimitar o objeto da estatística, a finalidade específica ou sua amplitude, nem esclarecer a necessidade da disponibilização ou como os dados seriam usados. Também houve preocupação com a segurança dos dados devido à estrutura de cargos em comissão do IBGE. Os direitos fundamentais à privacidade e sigilo de dados foram considerados imprescindíveis, mas relativos, exigindo análise de adequação, razoabilidade e proporcionalidade para sua relativização excepcional."
  },

  {
    ...
    opcoes: [
      ...
      "Dignidade da pessoa humana VS. Integridade física e psíquica",
      "Direito à educação VS. Princípio republicano"
    ],
    respostaCorretaIndex: 1,
    explicacao: "O autor da ação alegou ofensa ao princípio republicano (art. 1º, caput), dignidade da pessoa humana (art. 1º, III), vedação do preconceito de cor e discriminação (art. 3º, IV), repúdio ao racismo (art. 4º, III), e igualdade (art. 5º, I). Os arguidos defenderam a constitucionalidade com base no princípio da dignidade da pessoa humana e a compreensão das políticas de ação afirmativa como deveres extraídos de princípios constitucionais para combater a discriminação e promover a igualdade."
  },

  {
    ...
    opcoes: [
      ...
      "Proteção à vida VS. Autonomia da vontade",
      "Proteção à vida VS. Honra"
    ],
    respostaCorretaIndex: 2,
    explicacao: "O cerne da colisão se deu entre a proteção à vida (em tese, desde a concepção) e os direitos fundamentais da gestante: dignidade da pessoa humana (art. 1º, IV), legalidade, liberdade e autonomia da vontade (art. 5º, II), e saúde (art. 6º, caput, e 196). Argumentou-se pela atipicidade do ato (considerando a anencefalia como incompatível com a vida fora do útero), a necessidade de uma interpretação evolutiva do Código Penal de 1940, e a prevalência dos princípios constitucionais da dignidade e saúde."
  },
];